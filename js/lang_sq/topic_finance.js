(function topicFinance() {
  ...
  // Finance Articles
  fetch("https://newscatcher.p.rapidapi.com/v1/latest_headlines?topic=finance&lang=sq&country=AL&media=True", settings)
          ...
          <div class="col-sm-4 grid-margin">
            <div class="position-relative">
              ...
              <div class="badge-positioned">
                <span class="badge badge-success font-weight-bold">Financa</span>
              </div>
            </div>
          </div>
