(function topicNews() {
  ...
  // News Articles
  fetch("https://newscatcher.p.rapidapi.com/v1/latest_headlines?topic=news&lang=sq&country=XK&media=True", settings)
          ...
          <div class="col-sm-4 grid-margin">
            <div class="position-relative">
              ...
              <div class="badge-positioned">
                <span class="badge badge-success font-weight-bold">Lajme</span>
              </div>
            </div>
          </div>
