(function topicFood() {
  ...
  // Food Articles
  fetch("https://newscatcher.p.rapidapi.com/v1/latest_headlines?topic=food&lang=sq&country=AL&media=True", settings)
          ...
          <div class="col-sm-4 grid-margin">
            <div class="position-relative">
              ...
              <div class="badge-positioned">
                <span class="badge badge-success font-weight-bold">Ushqimi</span>
              </div>
            </div>
          </div>
